...
CORS許可origin: `https://bs-job-board-web.masa-nekoshinshi39.workers.dev`, `http://localhost:5173`
...
| Method | Path | 処理 |
|--------|------|------|
| GET | `/:aiRunId/events` | AI run進捗のSSE stream（queued/admitted/generating/repairing/completed/failed） |
...
| posts | 投稿（thread_id, post_number, body, author_type, source_post_number, parent_post_id） |
