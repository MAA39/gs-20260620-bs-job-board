      ...
      <head>
        ...
        <style>{`
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          header nav a { color: #8888ff; margin-left: 16px; text-decoration: none; }
          ...
          .badge-human { background: #f3e5f5; color: #6a1b9a; }
          ...
          .post-ai { border-left-color: #e91e63; background: #fff5f5; }
